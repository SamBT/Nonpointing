...
void plot_yield_tables() {
	...
	TString fname;
	TString data_sing = "/global/homes/s/sambt/workarea/nonpointing/analysis_output/singlephoton/data/output_data.root";

	plot("h_yield","data_projected_singlephoton","SR",data_sing);
	plot("h_yield_raw","data_singlephoton","CR",data_sing);
