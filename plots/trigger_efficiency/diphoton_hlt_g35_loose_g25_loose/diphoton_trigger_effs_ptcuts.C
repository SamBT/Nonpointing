...
void plot(TString type, TString var, TString append) {
	...
	TString ratio = "h_" + var + "_trigger_eff" + append;
	...
	TCanvas *c = new TCanvas();
  	...
  	if (var == "pt1") l.DrawLatex(0.65,0.9,"p_{T1} > 40 GeV");
  	ATLASLabel(0.65,0.75,"Internal");

  	TString output = type + "_" + var + "_trigger_efficiency" + append +"_SBT";
...
void diphoton_trigger_effs_ptcuts() {
	//plot("diphoton","pt1");
	plot("diphoton","pt2","_pt1_40");
}
