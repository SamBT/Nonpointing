void plot_diphoton_bkgest() {
  ...
  y15->Draw("text");
  TString message = "Data 2015, Diphoton, Projected Yield in SR, Scaled to 32.8846 fb^{-1}";
  TLatex l;
  l.SetNDC();
  l.SetTextSize(0.04);
  l.DrawLatex(0.2,0.9,message);
  c1->SaveAs("data15_projected_diphoton_SR_yield_SBT.png");
  c1->SaveAs("data15_projected_diphoton_SR_yield_SBT.pdf");
  c1->SaveAs("data15_projected_diphoton_SR_yield_SBT.eps");
  c1->SaveAs("data15_projected_diphoton_SR_yield_SBT.C");

  TCanvas *c2 = new TCanvas();
  y16->Draw("text");
  message = "Data 2016, Diphoton, Projected Yield in SR";
  l.SetNDC();
  l.SetTextSize(0.04);
  l.DrawLatex(0.2,0.9,message);
  c2->SaveAs("data16_projected_diphoton_SR_yield_SBT.png");
  c2->SaveAs("data16_projected_diphoton_SR_yield_SBT.pdf");
  c2->SaveAs("data16_projected_diphoton_SR_yield_SBT.eps");
  c2->SaveAs("data16_projected_diphoton_SR_yield_SBT.C");
