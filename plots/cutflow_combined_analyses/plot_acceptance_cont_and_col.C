...
void plot_acceptance_cont_and_col(TString timing, double tau, int hsbin, int hdbin, TString single_selection, TString di_selection) {
  TString name1, name2;
  ...
  TH2F *hs1_clone = (TH2F*)hs1->Clone();
  TH2F *hd1_clone = (TH2F*)hd1->Clone();
  ...
  hs1_clone->SetContour(3);
  hs1_clone->SetContourLevel(0,0.005);
  hs1_clone->SetContourLevel(1,0.01);
  hs1_clone->SetContourLevel(2,0.05);
  hs1_clone->Draw("CONT LIST");
  c1->Update();
  ...
  leg1.AddEntry(curv0,"0.5% Contour","l");
  leg1.AddEntry(curv1,"1% Contour","l");
  leg1.AddEntry(curv2,"5% Contour","l");
  leg1.Draw();
  TLatex l;
  l.SetNDC();
  TString s;
  ...
  TString s2;
  s2 = "acceptance_contour_weighted_"+timing+"_single_SBT";
  c1->SaveAs(s2+".png");
  c1->SaveAs(s2+".pdf");
  c1->SaveAs(s2+".eps");
  c1->SaveAs(s2+".C");
  ...
  gStyle->SetPaintTextFormat("4.1f");
  hd1_clone->SetContour(3);
  hd1_clone->SetContourLevel(0,0.005);
  hd1_clone->SetContourLevel(1,0.01);
  hd1_clone->SetContourLevel(2,0.05);
  hd1_clone->Draw("CONT LIST");
  c2->Update();
  conts0 = (TObjArray*)gROOT->GetListOfSpecials()->FindObject("contours");
  curv0 = (TGraph*)((TList*)conts0->At(0))->First();
  curv1 = (TGraph*)((TList*)conts0->At(1))->First();
  ...
  leg2.AddEntry(curv0,"0.5% Contour","l");
  leg2.AddEntry(curv1,"1% Contour","l");
  leg2.AddEntry(curv2,"5% Contour","l");
  leg2.Draw();
  l.SetNDC();
  ...
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "acceptance_contour_weighted_"+timing+"_di_SBT";
  c2->SaveAs(s2+".png");
  c2->SaveAs(s2+".pdf");
  c2->SaveAs(s2+".eps");
  c2->SaveAs(s2+".C");
  ...
  gStyle->SetPaintTextFormat("4.1f");
  hs2->SetContour(3);
  hs2->SetContourLevel(0,0.005);
  hs2->SetContourLevel(1,0.01);
  hs2->SetContourLevel(2,0.05);
  hs2->Draw("CONT LIST");
  c3->Update();
  conts0 = (TObjArray*)gROOT->GetListOfSpecials()->FindObject("contours");
  curv0 = (TGraph*)((TList*)conts0->At(0))->First();
  ...
  leg3.AddEntry(curv0,"0.5% Contour","l");
  leg3.AddEntry(curv1,"1% Contour","l");
  leg3.AddEntry(curv2,"5% Contour","l");
  leg3.Draw();
  l.SetNDC();
  s.Form("Single Photon, #tau = %.1f, ", tau);
  s += single_selection;
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "acceptance_contour_unwt_"+timing+"_single_SBT";
  c3->SaveAs(s2+".png");
  c3->SaveAs(s2+".pdf");
  c3->SaveAs(s2+".eps");
  c3->SaveAs(s2+".C");
  ...
  gStyle->SetPaintTextFormat("4.1f");
  hd2->SetContour(3);
  hd2->SetContourLevel(0,0.005);
  hd2->SetContourLevel(1,0.01);
  hd2->SetContourLevel(2,0.05);
  hd2->Draw("CONT LIST");
  c4->Update();
  conts0 = (TObjArray*)gROOT->GetListOfSpecials()->FindObject("contours");
  curv0 = (TGraph*)((TList*)conts0->At(0))->First();
  ...
  leg4.AddEntry(curv0,"0.5% Contour","l");
  leg4.AddEntry(curv1,"1% Contour","l");
  leg4.AddEntry(curv2,"5% Contour","l");
  leg4.Draw();
  l.SetNDC();
  s.Form("Diphoton, #tau = %.1f, ", tau);
  s += di_selection;
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "acceptance_contour_unwt_"+timing+"_di_SBT";
  c4->SaveAs(s2+".png");
  c4->SaveAs(s2+".pdf");
  c4->SaveAs(s2+".eps");
  c4->SaveAs(s2+".C");
