void cutflow_table(double dsid, int begin, int end) {
  ofstream t1, t2;
  TString t1_name = "cutflow.tex";
  TString t2_name = "cutflow_unwt.tex";
  ...
  ifstream info("../../dsid_mg_mx_tau.txt");
  while (!info.eof()) {
  ...
  TFile *fs = TFile::Open("/project/projectdirs/atlas/sambt/BatchOutput/nonpointing/reco_signal/combined/EXOT6_derivation/"+rootname);
  TFile *fd = TFile::Open("/project/projectdirs/atlas/sambt/BatchOutput/nonpointing/reco_signal/combined/HIGG1D1_derivation/"+rootname);
  ...
  t1 << std::fixed << std::setprecision(0) << mg << "&" << mx << "&" << std::fixed << std::setprecision(1) << tau << "&" << std::fixed << std::setprecision(2) << hs->GetBinContent(1) << "&" << hs->GetBinContent(2) << "&" << hs->GetBinContent(3) << "&" << hs->GetBinContent(4) << "&" << hs->GetBinContent(5) << "&" << hs->GetBinContent(6) << "&" << hs->GetBinContent(7) << "&" << hs->GetBinContent(8) << "&" << hs->GetBinContent(9) << "&" << hs->GetBinContent(10) << "&" << hs->GetBinContent(11) << "&" << hs->GetBinContent(12) << "&" << hs->GetBinContent(13) << "&" << hd->GetBinContent(2) << "&" << hd->GetBinContent(3) << "&" << hd->GetBinContent(4) << "&" << hd->GetBinContent(5) << "&" << hd->GetBinContent(6) << "&" << hd->GetBinContent(7) << "&" << hd->GetBinContent(8) << "&" << hd->GetBinContent(9) << "&" << hd->GetBinContent(10) << "\\\\ \n";
  t1 << "\\hline \n";
