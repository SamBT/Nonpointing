...
void plot_acceptance_contour(TString timing, double tau, int hsbin, int hdbin, TString single_selection, TString di_selection) {
  TString name1, name2;
  ...
  hs1->SetContour(3);
  hs1->SetContourLevel(0,0.005);
  hs1->SetContourLevel(1,0.01);
  hs1->SetContourLevel(2,0.05);
  hs1->Draw("CONT LIST");
  c1->Update();
  ...
  gStyle->SetPaintTextFormat("4.1f");
  hd1->SetContour(3);
  hd1->SetContourLevel(0,0.005);
  hd1->SetContourLevel(1,0.01);
  hd1->SetContourLevel(2,0.05);
  hd1->Draw("CONT LIST");
  c2->Update();
  conts0 = (TObjArray*)gROOT->GetListOfSpecials()->FindObject("contours");
  curv0 = (TGraph*)((TList*)conts0->At(0))->First();
