void plot_hists_col(TString timing, double tau, int hsbin, int hdbin, TString single_selection, TString di_selection) {
  TString name1, name2;
  ...
  TString s2;
  s2 = "cutflow_weighted_"+timing+"_single_col_SBT";
  c1->SaveAs(s2+".png");
  c1->SaveAs(s2+".pdf");
  c1->SaveAs(s2+".eps");
  c1->SaveAs(s2+".C");
  ...
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "cutflow_weighted_"+timing+"_di_col_SBT";
  c2->SaveAs(s2+".png");
  c2->SaveAs(s2+".pdf");
  c2->SaveAs(s2+".eps");
  c2->SaveAs(s2+".C");
  ...
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "cutflow_unwt_"+timing+"_single_col_SBT";
  c3->SaveAs(s2+".png");
  c3->SaveAs(s2+".pdf");
  c3->SaveAs(s2+".eps");
  c3->SaveAs(s2+".C");
  ...
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "cutflow_unwt_"+timing+"_di_col_SBT";
  c4->SaveAs(s2+".png");
  c4->SaveAs(s2+".pdf");
  c4->SaveAs(s2+".eps");
  c4->SaveAs(s2+".C");
