...
void plot_var_mgfixed(TString var, TString timing, double tau, int rebin, double xmin_lead, double xmax_lead, double xmin_sub, double xmax_sub) {
  double mg = 1200;
  double mx1, mx2, mx3;
  ...
  if (var == "MET") {
    ...
    leg.AddEntry(met1,"m_{#tilde{#chi}} = 200 GeV","l");
    leg.AddEntry(met2,"m_{#tilde{#chi}} = 600 GeV","l");
    leg.AddEntry(met3,"m_{#tilde{#chi}} = 1000 GeV","l");
    leg.Draw();
