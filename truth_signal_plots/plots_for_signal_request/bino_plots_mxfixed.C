...
void bino_plots_mxfixed(TString timing, double tau, int rebin, double xmin_lead, double xmax_lead, double xmin_sub, double xmax_sub, int rebin1, int rebin2) {
  double mx = 600;
  double mg1, mg2, mg3;
  ...
  lead1->GetXaxis()->SetTitle("Bino Lifetime");
  lead1->Draw("hist");
  lead2->Draw("histsame");
  lead3->Draw("histsame");
  TLatex l;
