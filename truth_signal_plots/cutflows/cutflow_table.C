void cutflow_table(TString timing, TString singlephoton, TString diphoton, double dsid, double tau, int begin, int end) {
  ofstream t1, t2;
  ...
  if (begin == 1) {
    ...
    t1 << "\\begin{document}\n";
    t1 << "\\begin{longtable}{|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}" << endl;
    t1 << "\\hline \n";
    t1 << "$m_{\\tilde{g}}$ & $m_{\\tilde{\\chi}_1^0}$ & $\\tau_{\\tilde{\\chi}_1^0}$ & Total & \\multicolumn{11}{|c|}{Singlephoton} & \\multicolumn{8}{|c|}{Diphoton} \\\\ \n";
    t1 << "\\hline \n";
    ...
    t2 << "\\begin{document}\n";
    t2 << "\\begin{longtable}{|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|c|}" << endl;
    t2 << "\\hline \n";
    t2 << "$m_{\\tilde{g}}$ & $m_{\\tilde{\\chi}_1^0}$ & $\\tau_{\\tilde{\\chi}_1^0}$ & Total & \\multicolumn{11}{|c|}{Singlephoton} & \\multicolumn{8}{|c|}{Diphoton} \\\\ \n";
    t2 << "\\hline \n"; 
	...
	TFile *fs = TFile::Open(singlephoton);
	TFile *fd = TFile::Open(diphoton);
	TH1F *hs = (TH1F*)fs->Get("h_CF");
	TH1F *hd = (TH1F*)fd->Get("h_CF");
	TH1F *hsn = (TH1F*)fs->Get("h_CF_unwt");
	TH1F *hdn = (TH1F*)fd->Get("h_CF_unwt");
	t1 << std::fixed << std::setprecision(0) << mg << "&" << mx << "&" << std::fixed << std::setprecision(1) << tau << "&" << std::fixed << std::setprecision(2) << hs->GetBinContent(1) << "&" << hs->GetBinContent(2) << "&" << hs->GetBinContent(3) << "&" << hs->GetBinContent(4) << "&" << hs->GetBinContent(5) << "&" << hs->GetBinContent(6) << "&" << hs->GetBinContent(7) << "&" << hs->GetBinContent(8) << "&" << hs->GetBinContent(9) << "&" << hs->GetBinContent(10) << "&" << hs->GetBinContent(11) << "&" << hs->GetBinContent(12) << "&" << hd->GetBinContent(2) << "&" << hd->GetBinContent(3) << "&" << hd->GetBinContent(4) << "&" << hd->GetBinContent(5) << "&" << hd->GetBinContent(6) << "&" << hd->GetBinContent(7) << "&" << hd->GetBinContent(8) << "&" << hd->GetBinContent(9) << "\\\\ \n";
	t1 << "\\hline \n";
	t2 << std::fixed << std::setprecision(0) << mg << "&" << mx << "&" << std::fixed << std::setprecision(1) << tau << "&" << std::fixed << std::setprecision(2) << hsn->GetBinContent(1) << "&" << hsn->GetBinContent(2) << "&" << hsn->GetBinContent(3) << "&" << hsn->GetBinContent(4) << "&" << hsn->GetBinContent(5) << "&" << hsn->GetBinContent(6) << "&" << hsn->GetBinContent(7) << "&" << hsn->GetBinContent(8) << "&" << hsn->GetBinContent(9) << "&" << hsn->GetBinContent(10) << "&" << hsn->GetBinContent(11) << "&" << hsn->GetBinContent(12) << "&" << hdn->GetBinContent(2) << "&" << hdn->GetBinContent(3) << "&" << hdn->GetBinContent(4) << "&" << hdn->GetBinContent(5) << "&" << hdn->GetBinContent(6) << "&" << hdn->GetBinContent(7) << "&" << hdn->GetBinContent(8) << "&" << hdn->GetBinContent(9) << "\\\\ \n";
	t2 << "\\hline \n";
