void plot_hists_col(TString timing, double tau) {
  TString name1, name2;
  ...
  TH2F *hs1 = (TH2F*)f1->Get("hs");
  TH2F *hd1 = (TH2F*)f1->Get("hd");
  TH2F *hs2 = (TH2F*)f2->Get("hs");
  TH2F *hd2 = (TH2F*)f2->Get("hd");
  ...
  l.SetNDC();
  TString s;
  s.Form("Single Photon, #tau = %.1f ns, E_{T}^{miss} > 200 GeV, t_{#gamma} > 2ns, Z_{DCA} > 200mm",tau);
  l.SetTextSize(0.03);
  ...
  hd1->Draw("COLZ");
  l.SetNDC();
  s.Form("Diphoton, #tau = %.1f ns, E_{T}^{miss} > 75 GeV, t_{#gamma} > 2ns, Z_{DCA} > 200mm",tau);
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
