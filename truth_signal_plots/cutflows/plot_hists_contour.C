...
void plot_hists_contour(TString timing, double tau) {
  TString name1, name2;
  ...
  leg1.AddEntry(curv2,"20 Events","l");
  leg1.Draw();
  TLatex l;
  l.SetNDC();
  TString s;
  s.Form("Single Photon, #tau = %.1f, E_{T}^{miss} > 200 GeV, t_{#gamma} > 1.5ns",tau);
  l.SetTextSize(0.04);
  ...
  leg2.AddEntry(curv2,"20 Events","l");
  leg2.Draw();
  l.SetNDC();
  s.Form("Diphoton, #tau = %.1f, E_{T}^{miss} > 75 GeV, t_{#gamma} > 1.5ns",tau);
  l.SetTextSize(0.04);
  l.DrawLatex(0.2,0.85,s);
  ...
  leg3.AddEntry(curv2,"20 Events","l");
  leg3.Draw();
  l.SetNDC();
  s.Form("Single Photon, #tau = %.1f, E_{T}^{miss} > 200 GeV, t_{#gamma} > 1.5ns", tau);
  l.SetTextSize(0.04);
  ...
  leg4.AddEntry(curv2,"20 Events","l");
  leg4.Draw();
  l.SetNDC();
  s.Form("Diphoton, #tau = %.1f, E_{T}^{miss} > 75 GeV, t_{#gamma} > 1.5ns", tau);
  l.SetTextSize(0.04);
