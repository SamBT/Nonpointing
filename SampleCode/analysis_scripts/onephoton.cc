  ...
  gROOT->ForceStyle();
		 ...
		 for( int i = 0 ; i < numev ; i ++ )
		   {	
			 ...
			 //                         if( p->HLT_g140_loose == 1  && p->ph_pt1 > ptcut && p->ph_passIso1 && p->m_met < 20 ) h_CF -> Fill( 4.5, wt);
			 /*
			 if( p->m_met > metcut  ) h_CF -> Fill( 0.5, wt);
			 if( p->m_met > metcut && p->ph_pt1 > ptcut ) h_CF -> Fill( 1.5, wt);
			 if( p->m_met > metcut && p->ph_pt1 > ptcut && p->ph_passIso1 ) h_CF -> Fill( 2.5, wt);
			 if( p->m_met > metcut && p->ph_pt1 > ptcut && p->ph_passIso1 && p->HLT_g140_loose == 1 ) h_CF -> Fill( 3.5, wt);
			 if( p->m_met < 20     && p->ph_pt1 > ptcut && p->ph_passIso1 && p->HLT_g140_loose == 1 ) h_CF -> Fill( 4.5, wt);
			 */
			 ...
			 for( int l = 0 ; l < 6 ; l ++)
			   {
			     //			     cout << fabs( p->ph_calo_z1 - p->PV_z) << " " <<  p->ph_t1 << endl;
