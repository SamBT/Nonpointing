...
void plot_hists_cont_and_col(TString timing, double tau, int hsbin, int hdbin, TString single_selection, TString di_selection) {
  TString name1, name2;
  ...
  hs1_clone->SetContourLevel(0,5);
  hs1_clone->SetContourLevel(1,10);
  hs1_clone->SetContourLevel(2,15);
  ...
  hd1_clone->SetContourLevel(0,5);
  hd1_clone->SetContourLevel(1,10);
  hd1_clone->SetContourLevel(2,15);
