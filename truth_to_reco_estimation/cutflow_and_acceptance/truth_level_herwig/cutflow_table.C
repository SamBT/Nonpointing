void cutflow_table(double dsid, int begin, int end) {
  ...
  TFile *fs = TFile::Open("/project/projectdirs/atlas/sambt/BatchOutput/nonpointing/truth_herwig_signal/combined/truth_herwig_signal/"+rootname);
  TH1F *hs = (TH1F*)fs->Get("h_CF_single");
  TH1F *hd = (TH1F*)fs->Get("h_CF_di");
  TH1F *hsn = (TH1F*)fs->Get("h_CF_unwt_single");
  TH1F *hdn = (TH1F*)fs->Get("h_CF_unwt_di");
