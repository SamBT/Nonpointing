...
void plot_acceptance(TString timing, double tau, int hsbin, int hdbin, TString single_selection, TString di_selection) {
  TString name1, name2;
  ...
  TString s2;
  s2 = "acceptance_weighted_"+timing+"_single_SBT";
  c1->SaveAs(s2+".png");
  c1->SaveAs(s2+".pdf");
  c1->SaveAs(s2+".eps");
  c1->SaveAs(s2+".C");
  ...
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "acceptance_weighted_"+timing+"_di_SBT";
  c2->SaveAs(s2+".png");
  c2->SaveAs(s2+".pdf");
  c2->SaveAs(s2+".eps");
  c2->SaveAs(s2+".C");
  ...
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "acceptance_unwt_"+timing+"_single_SBT";
  c3->SaveAs(s2+".png");
  c3->SaveAs(s2+".pdf");
  c3->SaveAs(s2+".eps");
  c3->SaveAs(s2+".C");
  ...
  l.SetTextSize(0.03);
  l.DrawLatex(0.2,0.85,s);
  s2 = "acceptance_unwt_"+timing+"_di_SBT";
  c4->SaveAs(s2+".png");
  c4->SaveAs(s2+".pdf");
  c4->SaveAs(s2+".eps");
  c4->SaveAs(s2+".C");
