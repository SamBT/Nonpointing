void acceptance_table(TString timing, double tau) {
  ofstream t1, t2;
  TString t1_name = "acceptance_"+timing+".tex";
  TString t2_name = "acceptance_unwt_"+timing+".tex";
  ...
  double mg, mx;
  int binx, biny;
  TString fname = "hist_"+timing+".root";
  TFile *f = TFile::Open(fname);
  TString fname_unwt = "hist_unwt_"+timing+".root";
